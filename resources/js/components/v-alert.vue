<template>
    <div class="mb-4 border-l-4 rounded px-4 py-3" v-if="show" :class="style.wrapperColor" role="alert">
      <div class="flex items-center">
        <div class="py-1">
          <svg class="fill-current h-6 w-6 mr-4" :class="style.svgColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
        ...
        <div class="flex-1 flex justify-end items-center">
          <div class="cursor-pointer" @click="show = false">
            <svg class="fill-current h-4 w-4 ml-4" :class="style.svgColor + ' hover:' + style.wrapperColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
...
const style = computed(() => {
    switch (props.type) {
        case "info":
            return { wrapperColor: "bg-gray-100 text-gray-900 border-gray-500", svgColor: "text-gray-500" };
        case "warning":
          return { wrapperColor: "bg-yellow-100 text-yellow-900 border-yellow-500", svgColor: "text-yello-500" };
        case "success":
          return { wrapperColor: "bg-teal-100 text-teal-900 border-teal-500", svgColor: "text-teal-500" };
        case "danger":
          return { wrapperColor: "bg-red-100 text-red-900 border-red-500", svgColor: "text-red-500" };
    }
})
</script>
