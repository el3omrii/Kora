...
import VSettings from './components/settings/v-settings.vue';
import VDashboard from './components/dashboard/v-dashboard.vue';
...
app.component('v-settings', VSettings);
app.component('v-dashboard', VDashboard);
